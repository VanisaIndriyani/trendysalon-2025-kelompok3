        ...
        <div id="modal-add" class="fixed inset-0 bg-black/30 backdrop-blur-sm hidden z-40">
            <div class="absolute inset-0 flex items-center justify-center p-4">
                <div class="w-full max-w-lg max-h-[80vh] overflow-y-auto rounded-2xl bg-white ring-1 ring-stone-200 shadow-xl">
                    ...
                    <form method="POST" action="{{ route('admin.vitamins.store') }}" class="px-6 py-4 space-y-4">
                        @csrf
                        <div>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelectorAll('.btn-edit').forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        document.getElementById('form-edit').setAttribute('action', `{{ url('/admin/vitamins') }}/${id}`);
                ...
                document.querySelectorAll('.btn-delete').forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        document.getElementById('form-delete').setAttribute('action', `{{ url('/admin/vitamins') }}/${id}`);
